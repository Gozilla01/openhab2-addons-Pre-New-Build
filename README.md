...
|-------------------|------------------------|-------------------------|--------------------------|
|`bus_on_off_switch`   |WHO=1 Lightning |`where`</br>String</br>Value where OWN</br>`what`</br>Integer</br>Value what OWN</br>`addrtype`</br>Integer</br>Address type 1= Point to Point, 2= Area, 3= Group, 4= General| `switch`</br>Switch (R/W)</br>To switch the device `ON` and `OFF`                |
|`bus_automation`   |WHO=2 Automation |`where`</br>String</br>Value where OWN</br>`addrtype`</br>Integer</br>Address type 1= Point to Point, 2= Area, 3= Group, 4= General| `shutterPosition`</br>Rollershutter (R/W)</br>To activate roller shutters (UP, DOWN, STOP, Percent)</br>`shutterMotion`</br>Integer (R)</br>Roller shutter movement 0= stop, 1= up, 2= down               |
